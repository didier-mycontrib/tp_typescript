...
declare var Chart: {
    prototype: Chart;
    new(ctx:any,params:object): Chart;
};
...
type KeyOfMyGraphType = keyof typeof MyGraphType;
...
var myGraphDefaultBorderColors : Array<String>= [
 ...
 /*export */ class MySimpleGraph {
    ...
    private chart : object | undefined = undefined;
    ...
    public setTypeChartAsString(strTypeChart:string){
        this.chartType=MyGraphType[<KeyOfMyGraphType> strTypeChart];
    }
    ...
    render():void{
        ...
        let paramsOfChart : object ;
        paramsOfChart = {
            type: MyGraphType[<KeyOfMyGraphType> <unknown>this.chartType],
            data: {
        ...
        this.chart =  new Chart( ctx, paramsOfChart);
